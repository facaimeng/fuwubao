    ...
    */
    ...
    getResult : function(){
      var _self = this,
        ...
        root = _self.get('root');
        //alert(root);
        //alert(BUI.JSON.stringify(resultMap));
...
var Format =
{
    ...
    datetimeRenderer:function (d) {
        ...
        return date.getFullYear() + '-' + formatTimeUnit(date.getMonth() + 1) + '-' + formatTimeUnit(date.getDate()) + ' ' + formatTimeUnit(date.getHours()) + ':' + formatTimeUnit(date.getMinutes());
    },
    /**
