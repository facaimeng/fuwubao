...
function initMap(point) {
	...
	addMarker(point);// 向地图中添加marker
}

// 创建地图函数：
function createMap(point_str) {
	var map = new BMap.Map("dituContent");// 在百度地图容器中创建一个地图
	
	var temp = point_str.split(',');
...
var markerArr = [ {
	//title : "百恒网络",
	//content : "电话：0791-88117053<br/>手 机：15079002975",
	//point : "106.55429|29.555666",
	isOpen : 1,
	icon : {
		w : 23,
		h : 25,
