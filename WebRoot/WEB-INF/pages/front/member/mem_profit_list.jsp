     ...
     <ul class="clearfix nav bd">
		...
		<div class="investLeft fl">
		 	<ul class="leftNavList">
		     	<li id="assetAllNav" class="mgl0 "><a href="/member/asset/orders/" ><i class="leftNavList_4"></i>购买记录</a></li><!-- 
		        <li id="assetAllNav" class="mgl0 mgl0yes"><a href="/member/asset/profits/" class="cur"><i class="leftNavList_6"></i>收益记录</a></li>  -->
		     </ul>
		 </div> 
		     <form action="/member/asset/profits" name="sform" id="sform" >  
             <div class="investRight fl">
            	<h2>收益记录</h2>
                <div class="investCon grzx_gmjl">
                	<div class="grzx_gmjl_1">
                    	<span>交易时间：<input type="text"  id="start" name="start" value="${param.start}" class="Wdate" onFocus="WdatePicker({isShowClear:false,readOnly:false,dateFmt:'yyyy-MM-dd'});" style="width:154px;height:27px;"  placeholder="请选择日期" /> - <input type="text"  id="end" name="end" value="${param.end}" placeholder="请选择日期" class="Wdate" style="width:154px;height:27px;" onFocus="WdatePicker({isShowClear:false,readOnly:false,dateFmt:'yyyy-MM-dd'});"/><a id="dt0" data-dt="0" href="javascript:void(0);" class="dtclass ">最近6个月</a><a id="dt1" data-dt="1" href="javascript:void(0);" class="dtclass">一年</a><a href="javascript:void(0);" data-dt="-1" class="dtclass grzx_gmjl_1_on">搜索</a><a id="st0" href="javascript:void(0);" data-st="0" class="stclass">全部</a><a id="st1" data-st="1" href="javascript:void(0);" class="stclass">待收</a><a id="st2" data-st="2" href="javascript:void(0);" class="stclass">已收</a></span>
                    </div>
                   <table  cellpadding="0" cellspacing="0">
                   		<tr> 							
                        	<th>资产名称</th><th>起息日</th><th>投资金额(元)</th><th>年化率</th><th>产品期限</th><th>类型</th><th>状态</th><th>金额</th>
                        ...
                        <tr>
                        	...
                        	<td><fmt:formatDate value="${item.profit}" pattern="yyyy/MM/dd"/></td>
                        	<td>${item.stname}</td> 
                        </tr></c:forEach>
                   </table> 
                </div>
