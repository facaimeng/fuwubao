        ...
        BUI.use(['common/search','bui/overlay'],function (Search,Overlay) {
            ...
            var enumObj = {"1":"男","0":"女"},
                columns = [
	                ...
	                {title:'待还金额',dataIndex:'rpmoneyLabel',width:120},
	                {title:'还款时间',dataIndex:'pretime',width:160,renderer:BUI.Grid.Format.dateRenderer},
	                {title:'实际时间',dataIndex:'realtime',width:160,renderer:BUI.Grid.Format.datetimeRenderer},
	                {title:'操作',width:200,renderer:function(value,obj){
	                    var repayStr = '<span><a href="/system/loan/enter_replay_detail/?rpid='+obj.rpid+'">还款详情</a></span>&nbsp;&nbsp;';
	                    return  repayStr;
	                }}
                ],
