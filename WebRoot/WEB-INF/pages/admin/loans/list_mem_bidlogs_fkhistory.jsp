        ...
        BUI.use(['common/search','bui/overlay'],function (Search,Overlay) {
            ...
            var enumObj = {"1":"男","0":"女"},
                columns = [
	                ...
	                {title:'已放款金额',dataIndex:'bidmoneyLabel',width:100},
	                {title:'放款处理日期',dataIndex:'optime',width:100,renderer:BUI.Grid.Format.dateRenderer}, 
	                {title:'投资状态',width:120,renderer : function(value,obj,index){ 
    	  				return "<font id='b_"+obj.mblid+"'>"+obj.stname+"</font>"
    	  			}}
                ],
                
                store = Search.createStore('/system/bidlog/fangkuan_history/',{
					//autoLoad : true
				}),
