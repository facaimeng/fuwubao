 ...
 */
public class WildcardSqlMapClientFactoryBean implements FactoryBean<SqlMapClient>, InitializingBean {
	...
	public WildcardSqlMapClientFactoryBean() {
	...
	protected SqlMapClient buildSqlMapClient(
		...
		//替换你把提升本身的SqlMapConfigParser使ibatis能够支持通配符读取sqlmap文件
		WildcardSqlMapConfigParser configParser = new WildcardSqlMapConfigParser();
