...
public class DateUtils {
	...
	public static void main(String args[]) throws ParseException {
		 ...
		 * 
		 * //将calendar装换为Date类型 Date date = calendar.getTime();
		 * 
		 * //获取当前时间的前6个月 calendar.add(Calendar.MONTH, +6); Date date02 =
		 * calendar.getTime();
		 */

		System.out.println(matter.format(DateUtils.getDateAfter(matter.parse("2018-10-31"), 45)));
	}
